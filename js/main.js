(function () {
  ...
  var PRODUCTS = {
    ...
    bag: { name: 'Брандирана чанта', desc: 'Крафт хартиена чанта, 1 цвят', model: 'ELLEN', group: 'Чанти', currency: 'EUR', unit: '€', icon: 'pg-bag', image: 'images/products/ellen-bag.webp', prices: { 100: 1.26, 250: 1.01, 500: 0.92, 1000: 0.84 } },
